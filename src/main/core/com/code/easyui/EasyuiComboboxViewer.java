 ...
 *         Date:2014-08-05
 */
public class  EasyuiComboboxViewer implements Viewer {
    private boolean editable=true;
    public EasyuiComboboxViewer() {
    }

    public EasyuiComboboxViewer(boolean editable) {
    ...
    public static void main(String[] args){
        ...
        t1.setShowType("text");
        EasyuiComboboxViewer viewer=new EasyuiComboboxViewer();
