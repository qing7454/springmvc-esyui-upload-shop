...
public class TableFieldBean  implements Serializable{
    ...
    @ManyToOne()
    @JoinColumn(name ="table_head_id",referencedColumnName="id")
    @JsonIgnore
    private TableHeadBean head;
    ...
    public TableHeadBean getHead() {
        return head;
    }

    public void setHead(TableHeadBean head) {
        this.head = head;
    }
    @Transient
    ...
    public TableFieldBean(String id) {
        this.id = id;
    }
    @Transient
