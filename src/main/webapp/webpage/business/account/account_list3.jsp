...
//            setArea();
        ...
        function removeDelete(){
            ...
            jQuery.messager.confirm("提示","确定撤销删除的记录？",function(r){
                JSON.stringify();
                if(r==true){
                    var ids=new Array();
                    ...
                    ajaxJson(actionUrl+"?removeDelete",jQuery.param({id:ids[0]},true),function(data){
...
<div data-options="region:'north'" align="center" style="width: 100%;height: 150px;overflow: auto">
    <form id="searchForm" method="post">
        ...
        <input type="hidden" id="_order" name="orders"/>
            <%--异常账号--%>
        <input type="hidden" id="accountstate" name="accountstate" value="03"/>
        <table width="100%">
            <tr height="20">
...
<div id="tools" style="padding: 5px">
    ...
    <pro:authFilter buttonCode="detail" actionUrl="${_modulesLink}" >
        <a href="javascript:void(0);"  class=" easyui-linkbutton" iconCls="icon-edit" onclick="removeDelete()">撤销删除</a>
    </pro:authFilter>
