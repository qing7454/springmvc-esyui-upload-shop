...
<head>
    ...
    <script type="text/javascript" >
        ...
        function showUpdateDia(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_update.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","更新数据");
            openEasyuiDialog("editDia");
           // showBussinessWindow("更新","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_update.jsp?id="+row[0].id);
        }
        //打开新增对话框
        function showAddDia(){
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_update.jsp");
        ...
        function showDetail(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_detail.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_detail.jsp?id="+row[0].id);
        }
        ...
        function showDetailByDbClick(rowid){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_detail.jsp?id="+row[rowid].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/business/bankcard/bankcard_detail.jsp?id="+row[0].id);
   }
...
<body class="easyui-layout" title="银行卡信息" align="center" style="width: 900px;height: 650px" fit="true">
        <div data-options="region:'north'" align="center" style="width: 100%;height: 150px;overflow: auto" >
            <form id="searchForm" method="post">
                ...
                <input type="hidden" name="_tableName" id="_tableName" value="bankcard" />
                ...
                <table width="100%" >
                    ...
                    <tr height="30">
                        <td  width="10%" align="right">银行名称：</td><td><input class='easyui-validatebox'   style="width:190px"   name='bankname'  /></td>
                        <td  width="10%" align="right">卡号：</td><td><input class='easyui-validatebox'   style="width:190px"   name='cardnum'  /></td>
                        <td  width="10%" align="right">密码：</td><td><input class='easyui-validatebox'   style="width:190px"   name='password'  /></td>
                    </tr>
                    <tr>
                    </tr>
                    <tr align="center">
        ...
        <div data-options="region:'center'" style="height:500px;margin:20px 0 0 0;" align="center">
            ...
            <%@include file="bankcard_list_data_list_cache.jsp"%>
        </div>
