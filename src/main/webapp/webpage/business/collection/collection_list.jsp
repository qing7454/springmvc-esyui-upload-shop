...
<head>
    ...
    <script type="text/javascript" >
        ...
        function showUpdateDia(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/collection/collection_update.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","更新数据");
            openEasyuiDialog("editDia");
           // showBussinessWindow("更新","${pageContext.request.contextPath}/webpage/business/collection/collection_update.jsp?id="+row[0].id);
        }
        //打开新增对话框
        function showAddDia(){
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/collection/collection_update.jsp");
        ...
        function showDetail(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/collection/collection_detail.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/business/collection/collection_detail.jsp?id="+row[0].id);
        }
        ...
        function showDetailByDbClick(rowid){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/collection/collection_detail.jsp?id="+row[rowid].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/business/collection/collection_detail.jsp?id="+row[0].id);
   }
...
<body class="easyui-layout" title="收款管理表" align="center" style="width: 900px;height: 650px" fit="true">
        <div data-options="region:'north'" align="center" style="width: 100%;height: 150px;overflow: auto" >
            <form id="searchForm" method="post">
                ...
                <input type="hidden" name="_tableName" id="_tableName" value="collection" />
                ...
                <table width="100%" >
                    ...
                    <tr height="30">
                        <td  width="10%" align="right">收款类型：</td><td><input class='easyui-combobox'   style="width:190px"   name='collectionType' data-options="url:'${pageContext.request.contextPath}/sys/dic.do?dicList&dicKey=dic_key:dic_type=\'sklx\'' , method: 'get', valueField:'cKey',textField:'cValue',panelHeight:'auto'" /></td>
                        <td  width="10%" align="right">商家：</td><td><input class='easyui-validatebox'   style="width:190px"   name='shopid'  /></td>
                        <td  width="10%" align="right">收款账户：</td><td><input class='easyui-validatebox'   style="width:190px"   name='collectionAccount'  /></td>
                    </tr>
                    <tr>
                    </tr>
                    <tr align="center">
        ...
        <div data-options="region:'center'" style="height:500px;margin:20px 0 0 0;" align="center">
            ...
            <%@include file="collection_list_data_list_cache.jsp"%>
        </div>
