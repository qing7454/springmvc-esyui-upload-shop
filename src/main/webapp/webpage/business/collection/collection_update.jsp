        ...
        <table align="center" style="margin-top: 20px">
            <tr>
                ...
                <td style="padding: 5px">
                    <input class='easyui-combobox' name='collectionType'
                           data-options="url:'${pageContext.request.contextPath}/sys/dic.do?dicList&dicKey=dic_key:dic_type=\'sklx\'' , method: 'get', valueField:'cKey',textField:'cValue',panelHeight:'auto'"/>
                </td>
            ...
            <tr>
                ...
                <td style="padding: 5px">
                    <input class='easyui-datebox' name='collectionDate'
