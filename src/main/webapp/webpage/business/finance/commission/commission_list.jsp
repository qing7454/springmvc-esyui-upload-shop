...
<c:set var="actionUrl" scope="request">
    ${pageContext.request.contextPath}/business/commission.do
</c:set>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function getDataList1(back) {
            ...
            ajaxJson(actionUrl + "?dataGrid1", $("#searchForm").serialize(), function (data) {
        ...
        function showUpdateDia() {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/finance/commission/commission_update.jsp?id=" + row[0].id);
            $("#editDia").dialog("setTitle", "更新数据");
            openEasyuiDialog("editDia");
            // showBussinessWindow("更新","${pageContext.request.contextPath}/webpage/business/finance/commission/commission_update.jsp?id="+row[0].id);
        }
        //打开新增对话框
        function showAddDia() {
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/finance/commission/commission_update.jsp");
        ...
        function showDetail() {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/finance/commission/commission_detail.jsp?id=" + row[0].id);
        ...
        function showDetailByDbClick(rowid) {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/finance/commission/commission_detail.jsp?id=" + row[rowid].id);
            $("#editDia").dialog("setTitle", "数据详情");
            openEasyuiDialog("editDia");
        }
...
<body class="easyui-layout" title="佣金统计表" align="center" style="width: 900px;height: 650px" fit="true">
<div data-options="region:'north'" align="center" style="width: 100%;height: 130px;overflow: auto">
    <form id="searchForm" method="post">
        ...
        <input type="hidden" name="_tableName" id="_tableName" value="commission"/>
        ...
        <table width="100%">
            ...
            <tr height="30">
                ...
                <td><input class='easyui-validatebox' style="width:190px" name='shopName'/></td>
                <td width="10%" align="right">开始时间：</td>
                <td><input class='easyui-datebox' style="width:190px" name='startDate'
                           data-options="panelWidth: 230,formatter:myformatter,parser:myparser"/></td>
                <td width="10%" align="right">结束时间：</td>
                <td><input class='easyui-datebox' style="width:190px" name='endDate'
                           data-options="panelWidth: 230,formatter:myformatter,parser:myparser"/></td>
            </tr>
            <tr align="center">
                <td colspan="6" style="border-bottom:1px solid #d8d8d8;padding:5px 25px 10px 0;height:25px;">
                    <a href="javascript:void(0);" class=" easyui-linkbutton" onclick="getDataList1()">查询</a>
...
<div data-options="region:'center'" style="height:500px;margin:0 0 0 0;" align="center">
    <table width="100%">
        <tr style="height: 20px">
            <td style="font-size: 20px">佣金总计:<span id="commission"></span></td>
        </tr>
        <tr height="20">
    ...
    <%@include file="commission_list_data_list_cache.jsp" %>
</div>
<div data-options="region:'south'">
    <div class="easyui-panel" style="height: 38px;">
        <div id="pager" class="easyui-pagination"
             data-options="showRefresh:false,showPageList:false,total:0,onSelectPage: function(pageNumber, pageSize){ $('#pageNum').val(pageNumber); getDataList1();}"></div>
    </div>
</div>
