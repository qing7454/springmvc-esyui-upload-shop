...
<head>
    ...
    <script type="text/javascript">
        ...
        function showDetail() {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/freeorder/t_order_detail.jsp?id=" + row[0].id);
        ...
        * 免除佣金
        ...
        function exempt(){
            ...
            jQuery.messager.confirm("提示","确定免除选中的订单的佣金吗？",function(r){
                if(r == true){
                    $.ajax({
                        url: "${pageContext.request.contextPath}/business/freeOrder.do?exempt",
                        type: "post",
                        data: "id=" + row[0].id,
                        dataType: "json",
                        success: function (data) {
    ...
    <form id="searchForm" method="post">
        ...
        <table width="100%">
            ...
            <tr height="30">
                ...
                <td><input class='easyui-validatebox' style="width:190px" name='ddnum'/></td>
...
<div data-options="region:'center'" style="height:500px;margin:20px 0 0 0;" align="center">
    ...
    <%@include file="t_order_list_data_list_cache.jsp" %>
</div>
...
<div id="tools" style="padding: 5px">
    ...
    <a href="javascript:void(0);"  class=" easyui-linkbutton" iconCls="icon-edit" onclick="exempt()">免除佣金</a>
