...
<head>
    ...
    <script type="text/javascript" >
        ...
        //打开新增对话框
        function showAddDia(){
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/goods/goods_update.jsp");
        ...
        <div data-options="region:'north'" align="center" style="width: 100%;height: 150px;overflow: auto" >
            <form id="searchForm" method="post">
                ...
                <table width="100%" >
                    ...
                    <tr height="30">
                        <td  width="10%" align="right">商品ID：</td><td><input class='easyui-validatebox'   style="width:190px"   name='goodid'  /></td>
                        <td  width="10%" align="right">商品名称：</td><td><input class='easyui-validatebox'   style="width:190px"   name='goodname'  /></td>
                        <td  width="10%" align="right">商家ID：</td><td><input class='easyui-validatebox'   style="width:190px"   name='shopid'  /></td>
                    </tr>
                    <tr>
                    </tr>
                    <tr align="center">
