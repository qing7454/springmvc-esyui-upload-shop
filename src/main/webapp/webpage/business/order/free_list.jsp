...
<head>
    ...
    <script type="text/javascript">
        ...
        function showShDia() {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/order/free_sh_detail.jsp?id=" + row[0].id);
...
<div id="tools" style="padding: 5px">
    ...
    <a href="javascript:void(0);" class=" easyui-linkbutton" iconCls="icon-add" onclick="showShDia()">收货</a>
</div>
