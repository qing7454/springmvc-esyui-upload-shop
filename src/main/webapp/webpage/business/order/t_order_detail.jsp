...
<form id="editForm">
    ...
    <table align="center">
               <tr>
                    ...
                    <td style="padding: 5px">
                        <input class='easyui-datebox' disabled='disabled'   name='xdsj'  data-options="formatter:myformatter,parser:myparser" />
                    </td>
                ...
                <tr>
                    ...
                    <td style="padding: 5px">
                        <input class='easyui-datebox' disabled='disabled'   name='shdate'  data-options="formatter:myformatter,parser:myparser" />
                    </td>

 
                    <td style="padding: 5px">评价时间：</td>
                    <td style="padding: 5px">
                        <input class='easyui-datebox' disabled='disabled'   name='pjdate'  data-options="formatter:myformatter,parser:myparser" />
                    </td>
                ...
                <tr>
                    ...
                    <td style="padding: 5px">
                        <input class='easyui-numberbox' disabled='disabled' name='accountid'  />
                    </td>
