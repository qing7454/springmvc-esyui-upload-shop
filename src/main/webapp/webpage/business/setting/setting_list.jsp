...
<head>
    ...
    <script type="text/javascript" >
        ...
        function showUpdateDia(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/setting/setting_update.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","更新数据");
            openEasyuiDialog("editDia");
           // showBussinessWindow("更新","${pageContext.request.contextPath}/webpage/business/setting/setting_update.jsp?id="+row[0].id);
        }
        //打开新增对话框
        function showAddDia(){
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/setting/setting_update.jsp");
        ...
        function showDetail(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/setting/setting_detail.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/business/setting/setting_detail.jsp?id="+row[0].id);
        }
        ...
        function showDetailByDbClick(rowid){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/business/setting/setting_detail.jsp?id="+row[rowid].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/business/setting/setting_detail.jsp?id="+row[0].id);
   }
...
<body class="easyui-layout" title="规则设置" align="center" style="width: 900px;height: 650px" fit="true">
        <div data-options="region:'north'" align="center" style="width: 100%;height: 150px;overflow: auto" >
            <form id="searchForm" method="post">
                ...
                <input type="hidden" name="_tableName" id="_tableName" value="setting" />
                ...
                <table width="100%" >
                    ...
                    <tr height="30">
                        <td  width="10%" align="right">同店疲劳期：</td><td><input class='easyui-numberbox'  style="width:190px"  name='tdplq'  /></td>
                        <td  width="10%" align="right">同SKU疲劳期：</td><td><input class='easyui-numberbox'  style="width:190px"  name='tskuplq'  /></td>
                        <td  width="10%" align="right">月最多购买件数：</td><td><input class='easyui-numberbox'  style="width:190px"  name='gmjs'  /></td>
                    </tr>
                    <tr>
                        <td  width="10%" align="right">月最多购买金额：</td><td><input class='easyui-numberbox'  style="width:190px"  name='gmje'  /></td>
                    </tr>
                    <tr align="center">
        ...
        <div data-options="region:'center'" style="height:500px;margin:20px 0 0 0;" align="center">
            ...
            <%@include file="setting_list_data_list_cache.jsp"%>
        </div>
