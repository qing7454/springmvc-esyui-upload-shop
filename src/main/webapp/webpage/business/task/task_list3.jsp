...
<head>
    ...
    <script type="text/javascript">
        ...
        function getDataList(back) {
            ...
            ajaxJson(actionUrl + "?datagrid3", $("#searchForm").serialize(), function (data) {
        ...
        function assignTask() {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/task/task_assign.jsp?ids=" + ids);
            $("#editDia").dialog("setTitle", "数据详情");
            openEasyuiDialog("editDia");
        }
        function doTask() {
            ...
            $("#editFrame").attr("src", "${pageContext.request.contextPath}/webpage/business/task/task_execute.jsp?id=" + row[0].id);
            $("#editDia").dialog("setTitle", "数据详情");
            openEasyuiDialog("editDia");
        }
    ...
    <form id="searchForm" method="post">
        ...
        <table width="100%">
            ...
            <tr height="30">
                ...
                <td><input class='easyui-combobox' style="width:190px" name='tasktype'
                ...
                <td><input class='easyui-validatebox' style="width:190px" name='sku'/></td>
                <td width="10%" align="right">订单编号：</td>
                <td><input class='easyui-validatebox' style="width:190px" name='ordernun'/></td>
            </tr>
            <tr>
            </tr>
            <tr align="center">
...
<div id="tools" style="padding: 5px">
    <pro:authFilter buttonCode="detail" actionUrl="${_modulesLink}">
        <a href="javascript:void(0);" class=" easyui-linkbutton" iconCls="icon-edit" onclick="doTask()">查看任务</a>
    </pro:authFilter>
