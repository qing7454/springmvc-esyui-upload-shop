...
<table id="dataTable" class="easyui-datagrid" align="center"
    ...
    <thead>
    <tr>
        <th field='tasktype' sortable="true" data-options="width:100,formatter: function(value,row,index){ return getDicValue('dic_key:dic_type=\'rwlx\'','','',value);}">任务类型</th>
        <th field='shopname' data-options="width:100" sortable="true">店铺名</th>
        <th field='sku' data-options="width:100" sortable="true">SKU</th>
        <th field='sdfs' data-options="width:100" sortable="true">刷单方式</th>
        <th field='keyword' data-options="width:100" sortable="true">关键词</th>
        <th field='mark' data-options="width:100" sortable="true">备注</th>
        <th field='ordernun' data-options="width:100" sortable="true">订单编号</th>
        <th field='pjwz' data-options="width:100" sortable="true">评价文字</th>
        <th field='sfst' data-options="width:100" sortable="true">是否晒图</th>
        <th field='picture' data-options="width:100" sortable="true">图片名称</th>
