        ...
        <table align="center">
            <tr>
                ...
                <td style="padding: 5px">
                    <input class='easyui-combobox' name='tasktype'
                ...
                <td style="padding: 5px">
                    <select name="sdfs" style="width: 147px" class='easyui-combobox'>
            ...
            <tr>
                ...
                <td style="padding: 5px">
                    <select name="sfst" style="width: 147px" class='easyui-combobox'>
                        <option value=""></option>
