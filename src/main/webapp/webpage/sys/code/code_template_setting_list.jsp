...
<c:set var="tableName" value="code_template_setting"/>
<!DOCTYPE html>
<html>
<head>
    <title>代码生成器设置</title>
    ...
    <script type="text/javascript" >
        ...
        function showUpdateDia(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/sys/code/code_template_setting_update.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","更新数据");
            openEasyuiDialog("editDia");
           // showBussinessWindow("更新","${pageContext.request.contextPath}/webpage/sys/code/code_template_setting_update.jsp?id="+row[0].id);
        }
        //打开新增对话框
        function showAddDia(){
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/sys/code/code_template_setting_update.jsp");
        ...
        function showDetail(){
            ...
            $("#editFrame").attr("src","${pageContext.request.contextPath}/webpage/sys/code/code_template_setting_detail.jsp?id="+row[0].id);
            $("#editDia").dialog("setTitle","数据详情");
            openEasyuiDialog("editDia");
            //showBussinessWindow("详情","${pageContext.request.contextPath}/webpage/sys/code/code_template_setting_detail.jsp?id="+row[0].id);
        }
        //操作按钮
...
<body class="easyui-layout" title="代码生成器设置" align="center" style="width: 900px;height: 650px" fit="true">
        <div data-options="region:'north'" class="search_frame" align="center" >
            <form id="searchForm" method="post">
                ...
                <input type="hidden" name="_tableName" id="_tableName" value="code_template_setting" />
                <table >
                    <tr>
                        <td>生成类路径：</td><td><input class='easyui-validatebox'   name='javaPath'  /></td>
                        <td>生成视图路径：</td><td><input class='easyui-validatebox'   name='viewPath'  /></td>
                    </tr>
                    <tr>
        ...
        <div data-options="region:'center'" style="height:500px;margin:20px 0 0 0;" align="center">
            <%@include file="code_template_setting_list_data_list_cache.jsp"%>
