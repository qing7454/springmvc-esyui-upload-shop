...
<form id="editForm">
    ...
    <table align="center">
        <tr>
            ...
            <td style="padding: 5px"><%=(viewUtil.getDetailShow(fieldBean)+"").replace("${pageContext.request.contextPath}",request.getContextPath())%></td>
            <%
                if(count%3==0){
            %>
        </tr>
                    ...
                    <%
                        ...
                        if(CollectionUtils.isNotEmpty(tableFieldBeans)){
                            for(TableFieldBean tableFieldBean:tableFieldBeans){
                                if(!tableFieldBean.isShowList()) continue;
                    %>
