    ...
    <table align="center">
        <tr>
            ...
            <td style="padding: 5px">
                <input class='easyui-validatebox'   name='mName'  />
            </td>

            <td style="padding: 5px">表名：</td>
            <td style="padding: 5px">
                <input class='easyui-validatebox'   name='mTablename'  />
            </td>
         </tr>
         <tr>
            ...
            <td style="padding: 5px">
                <input class='easyui-validatebox'   name='mField'  />
            </td>

            <td style="padding: 5px">字段值：</td>
            <td style="padding: 5px">
                <input class='easyui-validatebox'   name='mValue'  />
            </td>
         </tr>
         <tr>
        </tr>
