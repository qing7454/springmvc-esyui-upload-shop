    ...
    <table>
                 ...
                 <tr>
                    ...
                    <td style="padding: 5px">
                        <input class='easyui-validatebox' disabled='disabled'  name='pid'  />
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td style="padding: 5px">
                        <input class='easyui-validatebox' disabled='disabled'  name='roleCode'  />
                    </td>
                </tr>
                 <tr>
                    <td style="padding: 5px">角色名称：</td>
                    <td style="padding: 5px">
                        <input class='easyui-validatebox' disabled='disabled'  name='roleName'  />
                    </td>
                </tr>
                 <tr>
                    <td style="padding: 5px">角色描述：</td>
                    <td style="padding: 5px">
                        <input class='easyui-validatebox' disabled='disabled'  name='roleDesc'  />
                    </td>
                </tr>
                 <tr>
                    <td style="padding: 5px">允许上级拥有本角色权限：</td>
                    <td style="padding: 5px">
                        <input type='checkbox' disabled='disabled'  name='preThrough' value='1' />
                    </td>
                </tr>
     </table>
</form>
